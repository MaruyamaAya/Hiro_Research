...
prompts are downweighted with a nonzero exploration floor. This is a practical
online approximation, not DAPO's exact same-batch reject-and-resample
algorithm, and is named accordingly in the experiment matrix. It allows
uniform+historical filtering and Hiro+historical filtering to be compared
